  ...
  return (
    <div className="isolate bg-black px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className='mt-8 bg-amber-100/10 p-6 rounded-lg'>
              ...
              <li key={person.name}>
                <div className="flex items-center gap-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm/6 font-semibold text-gray-600">{person.Phone}</p>
                    <p className="text-sm/6 font-semibold text-gray-600">{person.Email}</p>
                  </div>
