...
const Test = () => {
  ...
  <div
    aria-hidden="true"
    className="absolute inset-x-1 md:top-0 inset-z-10 transform-gpu overflow-hidden blur-3xl sm:top-80"
  >
    <div
      style={{
        clipPath:
      ...
      className="movingShape relative left-[calc(50%-5rem)] aspect-[1155/678] w-[20rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#d503ff] to-[#9089fc] md:opacity-14 sm:opacity-30 sm:left-[calc(50%-15rem)] sm:w-[120rem]"
    />
  </div>
</div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-x-6 md:space-y-0 overflow-hidden px-6 sm:px-10">
        ...
        <div className="relative p-6 backdrop-blur-md bg-black/30 rounded-lg border-2 shadow-lg shadow-gray-750/30 max-w-lg w-full ">
          ...
          Utforska er data – få insikter direkt
          </h3>
          <p className="font-normal text-white text-center md:text-left">
          Här kan ni själva testa att visualisera er data och upptäcka mönster, trender och möjligheter.
           Genom interaktiv analys får ni en djupare förståelse för era kunder, processer och affärsflöden.
           </p>
        </div>
