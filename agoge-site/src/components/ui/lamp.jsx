...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[90vh] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <motion.div
          ...
          <div
            className="absolute  w-40 h-[80%] left-0   bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        <div
          className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-primary-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
